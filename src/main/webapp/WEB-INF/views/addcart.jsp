                ...
                <div class="flex-grow-1 align-self-center overflow-hidden">
                  <div>
                    <h5 class="text-truncate font-size-18">
                      <a href="#" class="text-dark">Waterproof Mobile Phone </a>
                    </h5>
                    ...
                    <p class="mb-0 mt-1">
                      Color : <span class="fw-medium">Gray</span>
                    </p>
                  </div>
                </div>
                    ...
                    <div class="mt-3">
                      ...
                      <h5 class="mb-0 mt-2">
                        <span class="text-muted me-2"
                          ><del class="font-size-16 fw-normal">$500</del></span
                        >$450
                      </h5>
                    </div>
                  </div>
          ...
          <div class="card border shadow-none">
            <div class="card-body">
              <div class="d-flex align-items-start border-bottom pb-3">
                <div class="me-4">
                  <img
                    src="https://www.bootdey.com/image/380x380/FF00FF/000000"
                    alt
                    class="avatar-lg rounded"
                  />
                </div>
                <div class="flex-grow-1 align-self-center overflow-hidden">
                  <div>
                    <h5 class="text-truncate font-size-18">
                      <a href="#" class="text-dark">Smartphone Dual Camera </a>
                    </h5>
                    <p class="text-muted mb-0">
                      <i class="bx bxs-star text-warning"></i>
                      <i class="bx bxs-star text-warning"></i>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="mt-3">
                      ...
                      <h5 class="mb-0 mt-2">
                        <span class="text-muted me-2"
                          ><del class="font-size-16 fw-normal">$280</del></span
                        >$240
                      </h5>
                    </div>
                  </div>
            ...
            <div class="card-body">
              <div class="d-flex align-items-start border-bottom pb-3">
                ...
                <div class="flex-grow-1 align-self-center overflow-hidden">
                  <div>
                    <h5 class="text-truncate font-size-18">
                      <a href="#" class="text-dark">Black Colour Smartphone </a>
                    </h5>
                    <p class="text-muted mb-0">
                      <i class="bx bxs-star text-warning"></i>
                      <i class="bx bxs-star text-warning"></i>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="mt-3">
                      ...
                      <h5 class="mb-0 mt-2">
                        <span class="text-muted me-2"
                          ><del class="font-size-16 fw-normal">$750</del></span
                        >$950
                      </h5>
                    </div>
                  </div>
            ...
            <div class="col-sm-6">
              <div class="text-sm-end mt-2 mt-sm-0">
                <a
                  ...
                  class="btn custom-orange-btn"
                >
                  <i class="mdi mdi-cart-outline me-1"></i> Login
                </a>
              </div>
            </div>
          </c:if>
