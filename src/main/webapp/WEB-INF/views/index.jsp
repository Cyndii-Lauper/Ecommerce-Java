            ...
            <header class="header">
                ...
                <section class="flex">
                    ...
                    <form action="search" method="POST" class="search-form">
                        <input value="${txtS}" type="search" id="search-box" name="txt" placeholder="tìm kiếm ở đây...">
                        <input class="search-form" type="submit">
                    </form>
                    <div class="shopping-cart">
                        <a href="cart" class="btn">Giỏ Hàng</a>
                        <c:if test="${not empty sessionScope.acc}">
                            <a href="order" class="btn">Đơn Hàng</a>
                        </c:if>
                    </div>
                    <form action="login" method="post" class="login-form">
                        ...
                        <c:if test="${sessionScope.acc == null}">
                            ...
                            <input name="user" type="text" placeholder="Tên của bạn" class="box">
                            <input name="pass" type="password" placeholder="Mật khẩu của bạn" class="box">
                            ...
                            <c:forEach items="${listP}" var="p">
                                ...
                                <div class="swiper-slide box">
                                    <a href="detail?pid=${p.id}">
                                        ...
                                        <input type="button" class="btn" onclick="buy('${p.id}')" value="Thêm vào giỏ" />
                                    </a>
                                </div>
                            </c:forEach>
            ...
            <section class="blogs" id="blogs">
                ...
                <div class="box-container">
                    ...
                    <div class="box">
                        ...
                        <div class="content">
                            <div class="icons">
                                <a href="#"> <i class="fas fa-user"></i> bởi người dùng </a>
                                <a href="#"> <i class="fas fa-calendar"></i> 1st 4, 2024 </a>
                            </div>
